...
<a href="{{ url_for('prestadores') }}">
Prestadores
</a>

<a href="{{ url_for('quero_servico') }}">
Pedir serviço
</a>
...
def prestadores():
    ...
    query = Prestador.query.filter_by(
        aprovado=True
    )
    ...
    if servico:
        ...
        query = query.filter(
            or_(
                Prestador.categoria.ilike(
                    like_servico
                ),
                Prestador.descricao.ilike(
                    like_servico
                ),
                Prestador.nome.ilike(
                    like_servico
                ),
            )
        )
...
@app.post(
    "/admin/prestador/<int:pid>/aprovar"
)
...
@app.post(
    "/admin/prestador/<int:pid>/excluir"
)
